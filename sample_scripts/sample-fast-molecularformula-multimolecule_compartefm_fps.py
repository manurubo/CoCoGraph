...
def process_batch(conjunto, model, num, b_molecule, cantidad, time_model):
    ...
    while contador_molecula < num_swaps_max:
        ...
        futures = [executor_gpu.submit(calculate_data_molecule_fps, graph, tensor, num_swaps, contador_molecula) for graph, tensor, num_swaps in zip(valid_graph_b, tensors_allmolecules, num_swaps)]
