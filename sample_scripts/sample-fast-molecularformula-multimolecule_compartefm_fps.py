...
if __name__ == "__main__":
    ...
    while True:  # Run indefinitely
        ...
        df_generated_batch.to_csv(f"mols_gen/{str_date}/generated_molecules_batch_{total_batches_processed}.csv", index=False) # save the generated molecules for each batch    
