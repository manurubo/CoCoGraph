...
# Detect if '-gen corr' was passed and set generated file name and graph dir accordingly
...
graph_dir_name = 'graficas_random_10K_positive_approach_corr' if use_corr else 'graficas_random_10K_positive_approach'
